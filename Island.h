...
private:
	...
	Island(const Island&) = delete; // disallow copy construction
	Island(Island&&) = delete; // disallow move construction
	Island& operator=(const Island&) = delete; // disallow copy assignment
	Island& operator=(Island&&) = delete; // disallow move assignment
};
